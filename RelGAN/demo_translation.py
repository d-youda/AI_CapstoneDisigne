...
from module import *
import argparse
import tensorflow.keras as keras #23.03.02 tensorflow import error
...
config = tf.compat.v1.ConfigProto() #tensorflow vereson1의 잔유물임
config.gpu_options.allow_growth = True
set_session(tf.compat.v1.Session(config=config)) #tensorflow vereson1의 잔유물임
